      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="mx-auto mt-6 max-w-2xl space-y-1 text-center text-lg text-muted-foreground">
          {whatWeDo.intro.map((p, i) => (
            <p key={p} className={i === whatWeDo.intro.length - 1 ? "font-semibold text-brand-light" : undefined}>
              {p}
            </p>
          ))}
        </div>
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-[1.6fr_1fr]">
          ...
          <div className="scorecard p-6 sm:p-8">
            <div className="mb-6 flex items-center justify-between border-b border-brand/30 pb-4">
              <h3 className="text-xl uppercase tracking-wider text-brand-light">Areas We May Evaluate</h3>
          ...
          {/* The goal */}
          <div className="flex flex-col justify-center rounded-lg border border-brand/40 bg-gradient-to-b from-brand/10 to-transparent p-6 sm:p-8">
            <Target className="mb-4 size-8 text-brand" aria-hidden />
